...
const DEFAULTS = {
  ...
  search: 'Search SKUs, a part #, or a keyword…',
  nav1: 'My Lists',
...
const PRESETS = {
  industrial: {
    ...
    search: 'Search SKUs, a part #, or a cross-reference…',
    nav1: 'My Garage',
  ...
  packaging: {
    ...
    search: 'Search SKUs, a size, or a case quantity…',
  ...
  medical: {
    ...
    search: 'Search SKUs, a part #, or an NDC…',
  ...
  automotive: {
    ...
    search: 'Search SKUs, a part #, or a VIN…',
    nav1: 'My Garage',
  ...
  electronics: {
    ...
    search: 'Search SKUs, a part #, or a spec…',
    nav1: 'My Projects',
  ...
  apparel: {
    ...
    search: 'Search SKUs, a style #, or a size…',
    nav1: 'My Sizes',
  ...
  food: {
    ...
    search: 'Search SKUs, an item #, or a brand…',
    nav1: 'My Pars',
  ...
  home: {
    ...
    search: 'Search SKUs, a style, or a collection…',
    nav1: 'My Boards',
  ...
  outdoors: {
    ...
    search: 'Search SKUs, a model #, or a brand…',
    nav1: 'My Gear',
  ...
  crafts: {
    ...
    search: 'Search SKUs, an item #, or a color…',
    nav1: 'My Stash',
...
const AI_FIELDS = [
  ...
  ['search', 52, 'Search box placeholder. Must start with "Search SKUs," and never state a catalog size: include a number only if the website text explicitly gives an exact product/SKU count'],
...
// The scene-side search token, exported so the document pre-fill can patch
// a known exact SKU count into an already-built profile's search swap.
export const STOCK_SEARCH_TOKEN = 'Search 48,000 SKUs, a part #, or a cross-reference…';
