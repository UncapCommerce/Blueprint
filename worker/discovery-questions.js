...
export const QUESTION_CATALOG = [
  ...
  { id: 'q-b2b-contract', step: 'Architecture', label: 'Do you offer contract pricing?', type: 'chips', options: ['Yes', 'No'] },
  { id: 'q-b2b-pricegroups', step: 'Architecture', label: 'How many price groups do you have?', type: 'text' },
  { id: 'q-b2b-collections', step: 'Architecture', label: 'Do you offer private product collections for specific customers?', type: 'chips', options: ['Yes', 'No'] },
  { id: 'q-b2b-qtyrules', step: 'Architecture', label: 'Which pricing and quantity rules do you use?', type: 'chips-multi', options: ['Tier Pricing', 'Min QTY', 'Max QTY', 'Increments'] },
  ...
  { id: 'q-payoptions', step: 'Architecture', label: 'Do you offer (payment options)', type: 'chips-multi', options: ['Credit Cards', 'ACH', 'Net Terms', 'PO Orders', 'Subscriptions', 'Account Credits'] },
