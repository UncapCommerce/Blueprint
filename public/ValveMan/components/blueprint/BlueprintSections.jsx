...
// "Approved" pill with a lime check-circle confirmation that persists for
// the tab session (sessionStorage), and fire-and-forget POSTs the session
// token to /api/auth/notify so denis@uncap.com gets a real-time
