...
function brandName() { return (window.__brand && window.__brand.name) || 'Carton Craft Supply'; }
    ...
    <section id="intro" data-bp-section="intro" style={{
      ...
      <div style={{ maxWidth: 1080, margin: '0 auto', width: '100%', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{
          ...
          <span>BLUEPRINT 013 · PREPARED JULY 2026 · CONFIDENTIAL</span>
        </div>
...
function GfxPhone({ kind }) {
  // Mobile Carton Craft Supply storefront. kind: 'home' | 'about' | 'blog'
  return (
    <div style={{
...
function BPApproveButton() {
  const APPROVED_KEY = 'cartoncraftsupply_approved_v1';
  ...
  const BRAND_NAME              = 'Carton Craft Supply';
