...
function brandName() { return (window.__brand && window.__brand.name) || 'VIVO'; }
    ...
    <section id="intro" data-bp-section="intro" style={{
      ...
      <div style={{ maxWidth: 1080, margin: '0 auto', width: '100%', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{
          ...
          <span>BLUEPRINT 011 · PREPARED JUNE 2026 · CONFIDENTIAL</span>
        </div>
      ...
      <div style={{
        ...
        <div style={{ padding: 'clamp(28px, 3.4vw, 52px)', borderLeft: '1px solid #1F1F1F', display: 'flex', flexDirection: 'column', gap: 'clamp(18px, 2vw, 26px)' }}>
          ...
          <div style={{ padding: 'clamp(18px, 2vw, 26px) clamp(20px, 2.2vw, 28px)', background: 'var(--uc-signal)', borderRadius: 12, boxShadow: '0 22px 60px -26px rgba(232,255,82,0.45)' }}>
            <div style={{ marginTop: 4, fontFamily: 'var(--font-hero)', fontWeight: 800, fontSize: 'clamp(52px, 6vw, 88px)', letterSpacing: '-0.05em', lineHeight: 0.85, color: 'var(--uc-black)' }}>$5k<span style={{ fontSize: '0.4em', letterSpacing: '-0.02em' }}> / mo</span></div>
          </div>
          {/* walk away */}
...
function BPProof() {
  ...
  const cards = [
    { v: 'dark', q: 'The team communicated consistently and efficiently — internal stakeholders were impressed with Uncap\u2019s vast technical expertise.', stat: '60 Days', statL: 'From Blueprint to upgraded live store', n: 'Todd Arey', c: 'E3 Spark Plugs' },
  ...
  return (
    <BPSection id="proof" n="19" label="Proof" paper tail="ON THE RECORD">
      <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1.4fr) minmax(0, 1fr)', gap: 'clamp(28px, 5vw, 80px)', alignItems: 'end' }}>
        ...
        <p style={{ margin: 0, maxWidth: 380, fontFamily: 'var(--font-serif)', fontSize: 'clamp(15px, 1.3vw, 18px)', lineHeight: 1.5, color: 'var(--fg-2)', textWrap: 'pretty' }}>
          Operators who ran the same play — upgraded, integrated, and grew on Shopify with Uncap.
        </p>
      </div>
...
function BPApproveButton() {
  const APPROVED_KEY = 'vivo_approved_v1';
