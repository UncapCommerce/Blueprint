...
function brandName() { return (window.__brand && window.__brand.name) || 'Anatomy Warehouse'; }
    ...
    <section id="intro" data-bp-section="intro" style={{
      ...
      <div style={{ maxWidth: 1080, margin: '0 auto', width: '100%', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{
          ...
          <span>BLUEPRINT 006 · PREPARED JUNE 2026 · CONFIDENTIAL</span>
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              A comprehensive plan to replatform Anatomy Warehouse on Shopify and unify commerce operations for B2C and B2B — with an exceptional customer experience designed for growth.
            </div>
          </div>
...
function BPGantt() {
  const groups = [
    ...
    { name: 'Production', range: 'WK 06–16', tasks: [
      { n: '05', t: 'Development',                tag: 'Build',    s: 6,  e: 15, range: 'W6–15' },
      { n: '06', t: 'Data Migration',             tag: 'Migrate',  s: 6,  e: 13, range: 'W6–13' },
      { n: '07', t: 'Integration',                tag: 'Connect',  s: 9,  e: 15, range: 'W9–15' },
      { n: '08', t: 'QA & Testing',               tag: 'Verify',   s: 14, e: 17, range: 'W14–17' }
    ] },
...
function BPTechStack() {
  const rows = [
    ...
    { name: 'Yotpo Product Reviews',     fn: 'Reviews + social proof',            pri: 'launch', cost: '~$119–199/mo' },
    ...
    <BPSection id="techstack" n="08" label="Architecture" dark grid tail="WHAT IT RUNS ON">
      ...
      <div style={{ border:'1px solid #1F1F1F', borderRadius:6, overflow:'hidden' }}>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'minmax(0,1.1fr) minmax(0,1.6fr) minmax(0,1.1fr) 120px', gap:16, padding:'14px 18px', borderTop:'1px solid #2B2B2B', background:'#0F0F0F', alignItems:'center' }}>
          ...
          <span/>
          <span style={{ fontFamily:'var(--font-hero)', fontWeight:800, fontSize:'clamp(18px,1.8vw,24px)', letterSpacing:'-0.03em', color:'var(--uc-paper)', textAlign:'right' }}>~$3,100/mo</span>
        </div>
      </div>
...
function BPDelivery() {
  const milestones = [
    ...
    { wk: 'WK 06', t: 'Storefront alpha + Migration start', s: 'Core theme + catalog in staging. Data migration begins.' },
    { wk: 'WK 09', t: 'Integrations live', s: 'ERP sync + B2B flows validated.' },
    { wk: 'WK 14', t: 'Migration + QA', s: 'Data moved, redirects, full QA pass.' },
    { wk: 'WK 17', t: 'Launch', s: 'Go live + 30-day support begins.' }
  ];
  return (
...
function BPProof() {
  ...
  const cards = [
    ...
    { v: 'signal', q: 'They are brilliant and very knowledgeable of all that Shopify can do.', stat: 'Config', statL: 'Custom product ordering for manufacturing', n: 'Peggy Farabaugh', c: 'Vermont Woods' },
...
function BPApproveButton() {
  const APPROVED_KEY = 'anatomywarehouse_approved_v1';
  ...
  const BRAND_NAME              = 'Anatomy Warehouse';
