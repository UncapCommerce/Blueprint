...
function Portal({ me, onSignOut }) {
  ...
  const framed = (tab === 'Discovery' && me.discovery) || (tab === 'Blueprint' && me.blueprint) || (tab === 'Estimate' && me.estimate);
      ...
      {framed ? (
        ...
        <div style={{ flex: '1 1 auto', overflowY: 'auto' }}>
          <div style={{ maxWidth: 1180, width: '100%', margin: '0 auto', padding: '30px 24px 60px', boxSizing: 'border-box' }}>
            ...
            {tab === 'Estimate' && (engagementStage(me) > 2
...
// The client-facing estimate one-pager renders as a standalone page framed in
// the Estimate tab (see `framed` above), served from /<id>/estimate/app.
